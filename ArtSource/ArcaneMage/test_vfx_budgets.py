...
out=pathlib.Path('F:/game/MythicVFXLab/Saved/VFXValidation/ArcaneMage/vfx_budgets.json');report={'ok':False,'samples':[]}
specs=[('Fireball','/Game/FireMage/Niagara/NS_PY_Fireball',44),('Charge','/Game/FireMage/Niagara/NS_PY_Charge',28),('FireImpact','/Game/FireMage/Niagara/NS_PY_Impact',66),('Flamestrike','/Game/FireMage/Niagara/NS_PY_Flamestrike',90),('Telegraph','/Game/FireMage/Niagara/NS_PY_Telegraph',25),('ArcaneMissile','/Game/ArcaneMage/Niagara/NS_AM_Missile',55),('ArcaneImpact','/Game/ArcaneMage/Niagara/NS_AM_Impact',32),('ArcaneChannel','/Game/ArcaneMage/Niagara/NS_AM_Channel',22)]
comps=[];first_frames={}
